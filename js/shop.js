    ...
    container.innerHTML = `
      <div class="product-detail-grid">
        ...
        <div class="product-detail-info">
          ...
          <a href="https://wa.me/8801757453611?text=${encodeURIComponent('Hi, I am interested in ' + p.title + ' (SKU: ' + p.sku + ')')}" class="btn btn-whatsapp" style="width:100%;" target="_blank" rel="noopener">WhatsApp enquiry</a>
