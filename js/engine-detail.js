        ...
        <div class="detail-info">
          ...
          <div class="purchase-panel">
            ...
            <div class="detail-actions purchase-actions">
              <a href="${emailBuyHref}" class="btn btn-primary btn-buy-email">
              ...
              <a href="${whatsappBuyHref}" class="btn btn-whatsapp btn-buy-whatsapp" target="_blank" rel="noopener noreferrer">
