...
const HOMEPAGE_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Your BMW deserves a powerplant that matches its engineering heritage. Whether that means a numbers-matching M20 for a concours E30, a low-mileage B58 for a daily F30, or a built S54 for a track E46 M3, Bavarian Engine Exchange has the inventory, the testing capability, and the technical expertise to deliver. Over 15,000 satisfied customers across Europe have trusted us with their engine projects. Browse our catalog, speak with our team, and let us help you find the perfect engine for your BMW today.",
  ...
  },
  {
    ...
    reverse: true,
    paragraphs: [
      "BMW diesel engines power millions of vehicles across Europe, and when they fail, the cost of dealer replacement can exceed the value of the vehicle. Bavarian Engine Exchange specialises in tested diesel replacements at a fraction of dealer cost. Our diesel inventory spans every generation from the old M21 and M41 units through M47, M57, N47, N57, B47, and B57 — over 1,200 diesel engines in stock at any time.",
  ...
  },
  {
    ...
    reverse: true,
    paragraphs: [
      "BMW M Performance engines represent the pinnacle of the company's engineering capability. From the naturally aspirated S54 that powered the E46 M3 to the twin-turbo S63 in modern M5 and M8 models, these powerplants demand respect, proper maintenance, and careful sourcing when replacement becomes necessary. Bavarian Engine Exchange maintains one of Europe's largest stocks of M Performance engines, each individually tested and documented.",
      ...
      "Investing in a performance BMW engine is a significant financial decision. Whether you are replacing a failed S55 in your F80 M3 or building an S54-powered track weapon from scratch, the engine you choose determines the reliability and performance ceiling of your entire project. Bavarian Engine Exchange provides the testing documentation, warranty protection, and technical expertise that performance builds demand. Contact our team to discuss your M Power requirements and receive recommendations tailored to your specific application and budget.",
      "Every performance engine we sell has been photographed from multiple angles, run on our dyno, and issued a test certificate before it appears in our catalog. We do not list engines speculatively or ship units that have not completed our full verification process. When you invest in an S54, S55, or S63 from Bavarian Engine Exchange, you invest in certainty — the certainty that your engine will perform as documented from the first turn of the key."
    ]
  },
  {
    tag: 'CONTACT US',
    ...
    paragraphs: [
      ...
      "We welcome visitors to our Hamburg facility by appointment. Seeing your engine in person, witnessing the dyno test, and meeting our technical team provides confidence that no photograph or report can fully replicate. Whether you are across the street or across the continent, Bavarian Engine Exchange is your partner for quality BMW engines, old and new, tested and warranted, delivered to your door. Browse our 3,100+ engine catalog today and discover why over 15,000 European customers trust us with their most important automotive projects."
    ]
  }
];
