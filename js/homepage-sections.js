...
const HOMEPAGE_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Every performance engine we sell has been photographed from multiple angles, run on our dyno, and issued a test certificate before it appears in our catalog. We do not list engines speculatively or ship units that have not completed our full verification process. When you invest in an S54, S55, or S63 from Premium BMW Engines, you invest in certainty — the certainty that your engine will perform as documented from the first turn of the key."
    ]
  },
  {
    tag: 'CONTACT US',
    ...
    paragraphs: [
      ...
      "We welcome visitors to our Hamburg facility by appointment. Seeing your engine in person, witnessing the dyno test, and meeting our technical team provides confidence that no photograph or report can fully replicate. Whether you are across the street or across the continent, Premium BMW Engines is your partner for quality BMW engines, old and new, tested and warranted, delivered to your door."
    ]
  }
];
