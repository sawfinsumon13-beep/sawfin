  ...
  <header class="site-header">
    <div class="container header-inner">
      ...
      <div class="header-actions">
        ...
        <button type="button" class="nav-toggle" id="nav-toggle" aria-label="Open menu" aria-expanded="false" aria-controls="nav-mobile"><span></span><span></span><span></span></button>
      </div>
    </div>
  </header>
...
function renderMobileNav() {
  ...
  <nav class="nav-mobile" id="nav-mobile" aria-label="Mobile navigation" aria-hidden="true">
    ...
    <a href="${SITE.waUrl}" target="_blank" rel="noopener">WhatsApp</a>
  </nav>`;
}
...
function renderFooter() {
  ...
  <footer class="site-footer">
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h4>Contact</h4>
          <a href="${SITE.waUrl}" target="_blank" rel="noopener">WhatsApp: ${SITE.phone}</a>
  ...
  <a href="${SITE.waUrl}" class="whatsapp-float" target="_blank" rel="noopener" aria-label="Chat on WhatsApp">
