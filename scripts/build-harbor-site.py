...
<section class="hero-split container" style="max-width:1180px;margin:0 auto">
  ...
  <div class="hero-copy">
    ...
    <div class="hero-cta">
      ...
      <a href="https://wa.me/4915510030835" class="btn btn-outline" target="_blank" rel="noopener">WhatsApp your VIN</a>
    </div>
...
<section class="section"><div class="container">
  <div class="contact-grid">
    ...
    <div class="contact-card"><div class="icon">💬</div><h3>WhatsApp</h3><p><a href="https://wa.me/4915510030835">+49 15510 030835</a><br>Photos & VIN checks</p></div>
    <div class="contact-card"><div class="icon">✉️</div><h3>Email</h3><p><a href="mailto:originalbavarianengine@gmail.com">originalbavarianengine@gmail.com</a><br>Quotes & invoices</p></div>
  </div>
  <p style="text-align:center"><a href="https://wa.me/4915510030835" class="btn btn-whatsapp" target="_blank" rel="noopener">Open WhatsApp chat</a></p>
</div></section>""",
    },
    "cart.html": {
        "page": "cart",
...
function spaNavigate(route, replace) {
  ...
  if (r.endsWith('-engines.html')) initCategory();
  updateBadge();
}
...
function initCategory() {
  ...
  const filtered = window.__PRODUCTS__.filter(p => p.category === cat).slice(0, 12);
...
function initChrome() {
  ...
  <footer class="site-footer"><div class="container footer-grid">
    ...
    <div><h4>Reach us</h4><a href="https://wa.me/${SITE_WA}">+49 15510 030835</a><a href="mailto:originalbavarianengine@gmail.com">Email desk</a></div>
